<template>
  <div class="region-container">
    ...
    <el-card class="table-card">
      <div class="toolbar">
        <el-button v-permission="'system:region:add'" type="primary" :icon="Plus" @click="handleAdd">新增区划</el-button>
      ...
      >
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            <el-button v-permission="'system:region:add'" type="primary" link :icon="Plus" @click="handleAddChild(row)">
              新增
            </el-button>
            <el-button v-permission="'system:region:edit'" type="primary" link :icon="Edit" @click="handleEdit(row)">
              编辑
            </el-button>
            <el-button v-permission="'system:region:delete'" type="danger" link :icon="Delete" @click="handleDelete(row)">
              删除
            </el-button>
          </template>
        </el-table-column>
