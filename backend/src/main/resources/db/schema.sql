...
CREATE TABLE `sys_ai_config` (
  ...
  `image_base_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '图片生成 API 地址',
  `image_model` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '图片生成模型名称',
  `image_adapter` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '图片生成适配器',
...
-- ----------------------------
DROP TABLE IF EXISTS `checkin_plan`;
